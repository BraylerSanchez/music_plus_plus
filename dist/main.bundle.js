...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.loadSharedPlaylist = function () {
        var _this = this;
        this.playlistService.searchShared().subscribe(function (result) {
            if (result.status == true)
                _this.sharedPlaylists = result.playlist;
        });
    };
...
/* harmony export */ __webpack_require__.d(exports, "d", function() { return AnimationStyleNormalizer; });/* unused harmony export ɵNoopAnimationStyleNormalizer */
/* harmony export */ __webpack_require__.d(exports, "c", function() { return AnimationDriver; });
/* harmony export */ __webpack_require__.d(exports, "g", function() { return NoopAnimationDriver; });
/* harmony export */ __webpack_require__.d(exports, "b", function() { return DomAnimationEngine; });
/* harmony export */ __webpack_require__.d(exports, "i", function() { return NoopAnimationEngine; });
/* harmony export */ __webpack_require__.d(exports, "f", function() { return WebAnimationsDriver; });
/* harmony export */ __webpack_require__.d(exports, "e", function() { return supportsWebAnimations; });/* unused harmony export ɵWebAnimationsPlayer */var __extends = (this && this.__extends) || function (d, b) {
...
/* harmony export */ __webpack_require__.d(exports, "NoopAnimationsModule", function() { return NoopAnimationsModule; });
/* harmony export */ __webpack_require__.d(exports, "ɵAnimationRenderer", function() { return AnimationRenderer; });
/* harmony export */ __webpack_require__.d(exports, "ɵAnimationRendererFactory", function() { return AnimationRendererFactory; });
/* harmony export */ __webpack_require__.d(exports, "ɵe", function() { return BROWSER_ANIMATIONS_PROVIDERS; });
/* harmony export */ __webpack_require__.d(exports, "ɵf", function() { return BROWSER_NOOP_ANIMATIONS_PROVIDERS; });
/* harmony export */ __webpack_require__.d(exports, "ɵa", function() { return InjectableAnimationEngine; });
/* harmony export */ __webpack_require__.d(exports, "ɵc", function() { return instantiateDefaultStyleNormalizer; });
/* harmony export */ __webpack_require__.d(exports, "ɵd", function() { return instantiateRendererFactory; });var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
};
...
var FooterPartialComponent = (function () {
    ...
    FooterPartialComponent.prototype.pauseEvent = function () {
    ...
    FooterPartialComponent.prototype.playEvent = function () {
    ...
    FooterPartialComponent.prototype.createPlayer = function () {
        var _this = this;
        var sounds = [];
        var playlist = this.playlistService.getCurrentPlaylist();
        if (playlist) {
            sounds = playlist.sounds.map(function (sound) {
                return _this.convertSound(sound);
            });
        }
    ...
    FooterPartialComponent.prototype.convertSound = function (sound) {
        return {
            title: sound.title,
    ...
    return FooterPartialComponent;
}());
FooterPartialComponent = __decorate([
    core_1.Component({
...
var HeaderPartialComponent = (function () {
    function HeaderPartialComponent(router, dialog, loginService) {
        this.router = router;
        this.dialog = dialog;
        this.loginService = loginService;
        this.searchQuery = '';
    ...
    HeaderPartialComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HeaderPartialComponent.prototype.showSearch = function (event) {
        this.searchXS = this.searchXS == '' ? 'search-xs' : '';
        event.stopPropagation();
        event.preventDefault();
    };
    HeaderPartialComponent.prototype.hideSearch = function () {
        this.searchXS = '';
    };
    HeaderPartialComponent.prototype.search = function () {
        if (this.searchQuery != '') {
            this.hideSearch();
            this.router.navigate(["/search/" + this.searchQuery]);
        }
    };
    HeaderPartialComponent.prototype.login = function () {
    ...
    HeaderPartialComponent.prototype.logout = function () {
        var result = confirm('Do you want logout from music++?');
        if (result)
            this.loginService.singOut();
    };
    return HeaderPartialComponent;
}());
HeaderPartialComponent = __decorate([
    core_1.Component({
...
exports.HeaderPartialComponent = HeaderPartialComponent;
...
SideBarComponent = __decorate([
    core_1.Component({
        ...
        providers: [login_service_1.LoginService, playlist_service_1.PlaylistService]
    }),
...
TemplateComponent = __decorate([
    core_1.Component({
        selector: 'app',
        templateUrl: 'client/templates/template.component.html'
    }),
    __metadata("design:paramtypes", [])
], TemplateComponent);
